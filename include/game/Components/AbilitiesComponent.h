...
#ifndef INCLUDE_GAME_COMPONENTS_ABILITIESCOMPONENT_H_
#define INCLUDE_GAME_COMPONENTS_ABILITIESCOMPONENT_H_
...
#endif  // INCLUDE_GAME_COMPONENTS_ABILITIESCOMPONENT_H_

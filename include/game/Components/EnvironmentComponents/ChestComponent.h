...
#ifndef INCLUDE_GAME_COMPONENTS_ENVIRONMENTCOMPONENTS_CHESTCOMPONENT_H_
#define INCLUDE_GAME_COMPONENTS_ENVIRONMENTCOMPONENTS_CHESTCOMPONENT_H_
...
#endif  // INCLUDE_GAME_COMPONENTS_ENVIRONMENTCOMPONENTS_CHESTCOMPONENT_H_

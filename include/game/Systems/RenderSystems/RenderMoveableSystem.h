...
#ifndef INCLUDE_GAME_SYSTEMS_RENDERSYSTEMS_RENDERMOVEABLESYSTEM_H_
#define INCLUDE_GAME_SYSTEMS_RENDERSYSTEMS_RENDERMOVEABLESYSTEM_H_
...
#endif  // INCLUDE_GAME_SYSTEMS_RENDERSYSTEMS_RENDERMOVEABLESYSTEM_H_
